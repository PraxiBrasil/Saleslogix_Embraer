...
<Columns>
   <asp:TemplateField   HeaderText="<%$ resources: grdOwnerJoins.a55f0c89-1a93-4664-b0dc-09928fd3c5b8.ColumnHeading %>"       SortExpression="Child.OwnerDescription"  >
    <itemtemplate>
      <SalesLogix:PageLink runat="server" NavigateUrl="User"
   EntityId='<%# dsOwnerJoins.getPropertyValue(Container.DataItem, "Child.User.Id") %>'     Text='<%# dsOwnerJoins.getPropertyValue(Container.DataItem, "Child.OwnerDescription") %>' 
         LinkType="EntityAlias"></SalesLogix:PageLink>
     </itemtemplate></asp:TemplateField>
      <asp:TemplateField   HeaderText="<%$ resources: grdOwnerJoins.fc314406-1177-41b9-9276-3ec602e71bd1.ColumnHeading %>"       SortExpression="OwnerSecurityProfile.ProfileDescription"  >
    <itemtemplate>
      <asp:HyperLink runat="server" 
    Text='<%# Server.HtmlEncode(Eval("OwnerSecurityProfile.ProfileDescription").ToString()) %>' 
          NavigateUrl='<%# string.Format(base.GetLocalResourceObject("grdOwnerJoins.fc314406-1177-41b9-9276-3ec602e71bd1.DestinationFormatString").ToString(), Server.HtmlEncode(Eval("Child.Id").ToString()), Server.HtmlEncode(Eval(" Parent.Id").ToString()), Server.HtmlEncode(Eval(" OwnerSecurityProfile.Id").ToString())) %>'  />
     </itemtemplate></asp:TemplateField>
      <asp:TemplateField   HeaderText="<%$ resources: grdOwnerJoins.e74c0ee5-5b87-4598-8487-487ffaf9e6c9.ColumnHeading %>"       SortExpression="CreateDate"  >
    <itemtemplate>
   <SalesLogix:DateTimePicker runat="server" ID="grdOwnerJoinscol3"  DisplayMode="AsText" DateTimeValue='<%#  dsOwnerJoins.getPropertyValue(Container.DataItem, "CreateDate")  %>'  CssClass=""  />
    ...
    <asp:TemplateField   HeaderText="<%$ resources: grdOwnerJoins.d79914ed-af89-4d0c-a9b3-11c8a8a77afe.ColumnHeading %>"       SortExpression="ModifyDate"  >
    <itemtemplate>
   <SalesLogix:DateTimePicker runat="server" ID="grdOwnerJoinscol4"  DisplayMode="AsText" DateTimeValue='<%#  dsOwnerJoins.getPropertyValue(Container.DataItem, "ModifyDate")  %>'  CssClass=""  />
    ...
    <asp:TemplateField   HeaderText="<%$ resources: grdOwnerJoins.aca10129-ab60-444e-83ff-b40df5239f0b.ColumnHeading %>"       SortExpression="ModifyUser"  >
    <itemtemplate>
  ...
  Text="<%$ resources: grdOwnerJoins.af0bb980-70a7-427f-a9c8-4e7486a6fbaf.Text %>"                >
  	    </asp:ButtonField>
   </Columns>
	...
	if (e.Row.RowType == DataControlRowType.DataRow)
	{
		if ((grdOwnerJoinsDeleteColumnIndex >= 0) && (grdOwnerJoinsDeleteColumnIndex < e.Row.Cells.Count))
		{
			...
			foreach (Control c in cell.Controls)
			{
				...
				if (btn != null)
				{
					btn.Attributes.Add("onclick", "javascript: return confirm('" + Sage.Platform.WebPortal.PortalUtil.JavaScriptEncode(GetLocalResourceObject("grdOwnerJoins.af0bb980-70a7-427f-a9c8-4e7486a6fbaf.ConfirmationMessage").ToString()) + "');");
					return;
				}
			}
		}
...
protected void grdOwnerJoins_RowCommand(object sender, GridViewCommandEventArgs e)
{
    ...
    if (Int32.TryParse(e.CommandArgument.ToString(), out rowIndex))
    {
		...
		if (e.CommandName.Equals("Delete"))
		{
		    ...
		    Sage.Platform.EntityFactory.Execute<Sage.Entity.Interfaces.IUser>("User.RemoveFromUserTeam", objarray);
		}
	}
...
<SalesLogix:LookupPreFilter PropertyName="Type" PropertyType="Sage.Entity.Interfaces.UserType" OperatorCode="!="
 ...
 ></SalesLogix:LookupPreFilter>
  ...
  <SalesLogix:PageLink ID="lnkUserTeamMembersHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="User_Detail_View_User_Team_Members_Tab" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink> </SalesLogix:SmartPartToolsContainer>
...
protected override void OnAddEntityBindings() { 
       dsOwnerJoins.Bindings.Add(new Sage.Platform.WebPortal.Binding.WebEntityListBinding("GetUserTeamMembers()", grdOwnerJoins ));
   dsOwnerJoins.BindFieldNames = new String[] { "ChildOwnerId"," ParentOwnerId","Child.OwnerDescription","Child.User.Id","OwnerSecurityProfile.ProfileDescription","Child.Id"," Parent.Id"," OwnerSecurityProfile.Id","CreateDate","ModifyDate","ModifyUser" };

...
protected void grdDefects_RowCommand(object sender, GridViewCommandEventArgs e)
{
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="TicketDefects_PrintView_RTools" ToolbarLocation="right">
   ...
   <SalesLogix:LookupControl runat="server" ID="lueDefect"  ToolTip="<%$ resources: lueDefect.ToolTip %>" LookupEntityName="Defect" LookupEntityTypeName="Sage.Entity.Interfaces.IDefect, Sage.Entity.Interfaces, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null" LookupDisplayMode="Text" AutoPostBack="true" LookupImageURL="~/ImageResource.axd?scope=global&type=Global_Images&key=associate_16x16"  >
<LookupProperties>

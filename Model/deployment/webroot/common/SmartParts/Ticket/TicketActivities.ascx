...
TextMode="MultiLine" Columns="40"
 ...
 ToolTip="<%$ resources: cmdCommentsDateStamp.ToolTip %>" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=User_Date_Stamp_16x16"  />
...
<tr>
 ...
 AlternateText="<%$ resources: cmdTicketActivities.Caption %>"  ToolTip="<%$ resources: cmdTicketActivities.ToolTip %>" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Save_16x16"  />
  ...
  <SalesLogix:PageLink ID="lnkTicketActivitiesHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="csrticketactivitiestab.htm" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink> </SalesLogix:SmartPartToolsContainer>
...
protected void cmdAdvanced_ClickAction(object sender, EventArgs e) {
    ...
    Response.Redirect("TicketActivity.aspx?modeid=insert");
}

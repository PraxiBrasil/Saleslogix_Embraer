...
ReadOnly="true" MaxLength="32"  />
 ...
 <div class=" lbl alignleft">
  ...
  <div  class="textcontrol lookup"  >
<SalesLogix:LookupControl runat="server" ID="lveUrgency" ButtonToolTip="<%$ resources: lveUrgency.ButtonToolTip %>" LookupEntityName="Urgency" LookupEntityTypeName="Sage.SalesLogix.Entities.Urgency, Sage.SalesLogix.Entities" LookupDisplayMode="DropDownList" AutoPostBack="true" AddEmptyListItem="false"  >
<LookupProperties>
...
<LookupPreFilters>
 ...
 <div class=" lbl alignleft">
   ...
   <div  class="textcontrol datepicker"  >
    <SalesLogix:DateTimePicker runat="server" ID="dtpAssignedDate" ToolTip="<%$ resources: dtpAssignedDate.ToolTip %>" ButtonToolTip="<%$ resources: dtpAssignedDate.ButtonToolTip %>" />
  </div>
...
<SalesLogix:Email runat="server" ID="emlAssignToEmail" ReadOnly="true" ButtonToolTip="<%$ resources: emlAssignToEmail.ButtonToolTip %>" EmailTextBoxStyle-ForeColor="#000099" EmailTextBoxStyle-Font-Underline="false" />
 ...
 />
  ...
  <SalesLogix:PageLink ID="lnkTicketDetailsHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="csrticketinfo.htm" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink> </SalesLogix:SmartPartToolsContainer>
...
protected void cmdPunchInOut_ClickAction(object sender, EventArgs e) {
    ...
    if (ticketActivity != null)
    {
        if (Convert.ToBoolean(Sage.Platform.Orm.DynamicMethodLibraryHelper.Instance.Execute("Ticket.IsDisplayActivityOnPunchOut", ticket)))
        {
			...
			Response.Redirect(string.Format("TicketActivity.aspx?entityId={0}", (ticketActivity as Sage.Platform.ComponentModel.IComponentReference).Id));
        }
        else
        {

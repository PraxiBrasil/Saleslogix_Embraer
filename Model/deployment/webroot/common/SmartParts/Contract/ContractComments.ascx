...
TextMode="MultiLine" Columns="40"
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="ContractComments_RTools" ToolbarLocation="right">
  <SalesLogix:PageLink ID="lnkContractCommentsHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="defectcommentstab.htm" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink> </SalesLogix:SmartPartToolsContainer>
